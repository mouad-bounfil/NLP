...
1) You are parsing a news story from cnbc.com. News story is stores in [news_story.txt](./news_story.txt) which is available in this same folder on github. You need to,
